package pt.iade.laisferreira.atividade.adapters;
...
import pt.iade.laisferreira.atividade.R;
...
public class NoteItemRowAdapter extends RecyclerView.Adapter<NoteItemRowAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.dateTitleView.setText(item.getModifiedDate().toString());
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            dateTitleView = itemView.findViewById(R.id.item_date);
